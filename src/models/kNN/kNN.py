...
from models.kNN.config import MODEL_PATH, TRAIN_STRIDE, N_NEIGHBORS
...
class KNNModel(SeriesModel):
    name = "knn"
    help = "kNN model — train or predict"
    predictions_filename = "knn_predictions.parquet"
